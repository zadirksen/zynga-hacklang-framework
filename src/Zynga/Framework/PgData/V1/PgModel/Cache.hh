...
class Cache implements CacheInterface {
  ...
  public function doesWriterOverrideKeyExist<TModelClass as PgRowInterface>(
    ...
    // We failed to load data from the cache.
    return false;
  }

  public function setWriterOverrideForWhereClause<TModelClass as PgRowInterface>(
    classname<TModelClass> $model,
    PgWhereClauseInterface $where,
  ): bool {
    try {
    ...
    // We encounter a failure when setting the override key
    return false;
  }
